...
\label{neon_8h_source}\index{Lost/Source/Lost/Vendor/GLM/glm/simd/neon.h@{Lost/Source/Lost/Vendor/GLM/glm/simd/neon.h}}
...
\DoxyCodeLine{11         \textcolor{keyword}{static} float32x4\_t dupq\_lane(float32x4\_t vsrc, \textcolor{keywordtype}{int} lane) \{}
...
\DoxyCodeLine{27         \}}
\DoxyCodeLine{28 }
\DoxyCodeLine{29         \textcolor{keyword}{static} float32x2\_t dup\_lane(float32x4\_t vsrc, \textcolor{keywordtype}{int} lane) \{}
...
\DoxyCodeLine{45         \}}
\DoxyCodeLine{46 }
\DoxyCodeLine{47         \textcolor{keyword}{static} float32x4\_t copy\_lane(float32x4\_t vdst, \textcolor{keywordtype}{int} dlane, float32x4\_t vsrc, \textcolor{keywordtype}{int} slane) \{}
...
\DoxyCodeLine{103         \}}
\DoxyCodeLine{104 }
\DoxyCodeLine{105         \textcolor{keyword}{static} float32x4\_t mul\_lane(float32x4\_t v, float32x4\_t vlane, \textcolor{keywordtype}{int} lane) \{}
...
\DoxyCodeLine{120         \}}
\DoxyCodeLine{121 }
\DoxyCodeLine{122         \textcolor{keyword}{static} float32x4\_t madd\_lane(float32x4\_t acc, float32x4\_t v, float32x4\_t vlane, \textcolor{keywordtype}{int} lane) \{}
